                                        ...
                                        <div class="table">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    $subtotal = 0;
                                                    $qproduk = "SELECT d.*, p.gambar, v.id_warna, v.id_ukuran, w.nm_warna, u.nm_ukuran
    ...
    WHERE d.id_order = '$id_order'";
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo htmlspecialchars($produk['nm_warna']); ?></td>
                                                            <td><?php echo htmlspecialchars($produk['nm_ukuran']); ?></td>
